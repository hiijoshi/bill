...
export default function UnitMasterPage() {
  ...
  const handleImportCsv = async (file: File) => {
    const { ok, result } = await uploadMasterCsv('/api/units/import', file, companyId || undefined)
    if (!ok) {
      alert(result.error || 'Unit import failed')
      return
    }
  ...
  if (loading) {
    return (
      <AppLoaderShell
        ...
        companyId=""
        fullscreen
        title="Loading unit master"
        message="Preparing conversion units, symbols, and quantity setup used across billing."
      />
    )
  }
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col gap-2 md:items-end">
              ...
              <MasterCsvTemplateHint templateKey="unit" />
            </div>
          </div>
