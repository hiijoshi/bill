...
export default function PaymentPageClient({
  ...
  useEffect(() => {
    ...
    setClientCache(`payment-page:${initialCompanyId}`, {
      purchaseBills: safePurchaseBills,
      salesBills: safeSalesBills,
      payments: safePayments
    })
  }, [initialCompanyId, initialPayments, initialPurchaseBills, initialSalesBills])
  ...
  useEffect(() => {
    if (!companyId) return
    if (hasInitialWorkspace && companyId === initialCompanyId) return
    let cancelled = false
    ;(async () => {
  ...
  }, [companyId, fetchPaymentData, hasInitialWorkspace, initialCompanyId])
