...
import { clearTraderClosureRequest, requestTraderClosure, TraderRetentionError } from '@/lib/trader-backups'
import { getTraderBackupHistory, getTraderDataLifecycleSummary } from '@/lib/trader-retention'

const actionSchema = z
  .object({
    action: z.enum(['request_closure', 'cancel_closure_request']),
